...
(function () {
  ...
  const EXACT = {
    ...
    '📢 Neue öffentliche und Ranglisten-Spiele werden im Matrix-Raum': '📢 New public and ranked games are announced in the Matrix room',
    'angekündigt – tritt bei und verpasse keine Runde!': '– join it and never miss a round!',
    '📢 Öffentliche Spiele erscheinen im Matrix-Raum': '📢 Public games are posted in the Matrix room',
    '– teile ihn mit deinen Mitspielern!': '– share it with your fellow players!',
    'Dieses Spiel wurde im Matrix-Raum angekündigt.': 'This game has been announced in the Matrix room.',
    ...
    'Per Matrix benachrichtigen, wenn sich mein Ranglistenplatz ändert': 'Notify me via Matrix when my ranking position changes',
    'Benachrichtigungen': 'Notifications',
    'Der Bot schreibt dir dann in euren privaten Chat, sobald du nach einem Ranglisten-Spiel auf- oder absteigst.': 'The bot will then message you in your private chat whenever you move up or down after a ranked game.',
    'Benachrichtigung aktiviert.': 'Notification enabled.', 'Benachrichtigung deaktiviert.': 'Notification disabled.',
